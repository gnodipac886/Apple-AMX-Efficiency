...
#     SINGLE_PE_OS_MAP_WIDGET   = SINGLE_PE_OS_DIR / 'map/map-widget.yaml'
    ...
    # System Manual
    #################################
    SYSTEM_MANUAL_DIR      = Path('')
    SYSTEM_AMX_DIR       = SYSTEM_MANUAL_DIR / 'arch/simple_output_stationary.yaml'
...
#     CONSTRAINTS_DIR     = SYSTEM_AUTO_DIR / 'constraints'
    EXAMPLE_CONSTRAINTS = SYSTEM_MANUAL_DIR / 'constraints/simple_output_stationary_map_constraints.yaml'
#     RELAXED_CONSTRAINTS = CONSTRAINTS_DIR / 'relaxed_constraints.yaml'
    MAPPER              = SYSTEM_MANUAL_DIR / 'mapper/mapper.yaml'
