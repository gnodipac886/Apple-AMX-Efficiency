...
#     PIM_MAPPER         = PIM_DIR / 'mapper/mapper.yaml'
    ...
    EYE_LARGE_DIR            = Path('example_designs/eyeriss_like')
    EYE_LARGE_ARCH           = EYE_LARGE_DIR / 'arch/eyeriss_like.yaml'
    EYE_LARGE_COMPONENTS_DIR = EYE_LARGE_DIR / 'arch/components'
    EYE_LARGE_CONSTRAINTS_MAP    = EYE_LARGE_DIR / 'constraints/eyeriss_like_map_constraints.yaml'
    EYE_LARGE_CONSTRAINTS_ARCH    = EYE_LARGE_DIR / 'constraints/eyeriss_like_arch_constraints.yaml'
    EYE_LARGE_MAPPER         = EYE_LARGE_DIR / 'mapper/mapper.yaml'
    
    OUT_LARGE_DIR            = Path('example_designs/simple_output_stationary')
    OUT_LARGE_ARCH           = OUT_LARGE_DIR / 'arch/simple_output_stationary.yaml'
    OUT_LARGE_ARCH_L2_DRAM           = OUT_LARGE_DIR / 'arch/simple_output_stationary_L2_DRAM.yaml'
    OUT_LARGE_ARCH_L3_DRAM           = OUT_LARGE_DIR / 'arch/simple_output_stationary_L3_DRAM.yaml'
    #'arch/simple_output_stationary.yaml'
    OUT_LARGE_ARCH_L2_L3_DRAM           = OUT_LARGE_DIR / 'arch/simple_output_stationary_L2_L3_DRAM.yaml'
    OUT_LARGE_COMPONENTS_DIR = OUT_LARGE_DIR / 'arch/components'
    OUT_LARGE_CONSTRAINTS_MAP    = OUT_LARGE_DIR / 'constraints/simple_output_stationary_map_constraints.yaml'
    OUT_LARGE_CONSTRAINTS_ARCH    = OUT_LARGE_DIR / 'constraints/simple_output_stationary_arch_constraints.yaml'
    OUT_LARGE_MAPPER         = OUT_LARGE_DIR / 'mapper/mapper.yaml'
    
    AMX_LARGE_DIR            = Path('example_designs/amx')
    AMX_LARGE_ARCH           = AMX_LARGE_DIR / 'arch/simple_output_stationary.yaml'
    AMX_LARGE_COMPONENTS_DIR = AMX_LARGE_DIR / 'arch/components'
    AMX_LARGE_CONSTRAINTS_MAP    = AMX_LARGE_DIR / 'constraints/simple_output_stationary_map_constraints.yaml'
    AMX_LARGE_CONSTRAINTS_ARCH    = AMX_LARGE_DIR / 'constraints/simple_output_stationary_arch_constraints.yaml'
    AMX_LARGE_MAPPER         = AMX_LARGE_DIR / 'mapper/mapper.yaml'
    ...
    ALEXNET = LAYER_SHAPES_DIR / 'AlexNet/AlexNet_layer1.yaml'
